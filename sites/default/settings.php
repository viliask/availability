...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_site_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_site_dd.inc';
}
// </DDSETTINGS>

$config_directories = array(
  CONFIG_SYNC_DIRECTORY => 'sites/default/files/config_acqTmp-2020-11-11T17.35.27-0041',
);
